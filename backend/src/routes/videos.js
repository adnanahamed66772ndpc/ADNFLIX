...
const { uploadVideo, serveVideo, deleteVideo, listVideos, uploadAudio, serveAudio, streamProxy } = require('../controllers/videoController.js');
...
// Proxy external video (avoids CORS: browser loads from our API, we stream from external URL)
