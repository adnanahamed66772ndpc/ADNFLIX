...
│   │   ├── lib/               # adProvider, sanitize, utils, videoUrl (CORS proxy helper)
...
The **Android/Flutter app** is in a separate repo: [adnflix-android](https://github.com/adnanahamed66772ndpc/adnflix-android). Clone it, set the API base URL in `lib/core/constants.dart`, and build with Flutter.
